resource "aws_apigatewayv2_api" "upload-service-gateway" {
  ...
  body          = templatefile("${path.module}/upload_service.yml", {
    ...
    import_service = data.terraform_remote_state.import_service.outputs.import_service_api_lambda_arn,
    ...
    app_deploy_service_lambda_arn = data.terraform_remote_state.app_deploy_service.outputs.service_lambda_arn,
